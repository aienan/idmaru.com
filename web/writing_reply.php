...
<?php
	$url = "writing_reply.php?";
	$page_name = "writing_reply";
	$table_name = "writing";
	$ad_fixbar_cond = "writing";
	$ad_pop_cond = "writing";
	$ad_side_cond = "writing";
	include 'declare.php';
		...
		<div id="mainbar">
			<div id="mainbody">
				...
				<nav class="menu_square">
					<a href="writing.php"><div id="menu_square_mine" class="menu_square_item">나의글</div></a>
					<a href="writing_friend.php"><div id="menu_square_friend" class="menu_square_item">친구글</div></a>
					<a href="writing_reply.php"><div id="menu_square_reply" class="menu_square_item">나의댓글</div></a>
				</nav>
				<div class="page_title_expr">※ 회원님이 댓글을 쓴 글을 볼 수 있습니다.</div>
				...
				<div class="content_area">
					<div id="writing_area">
<?php
	if($user_num != 0){include 'writing_reply_recall.php';}
	else {echo '<div class="guest_inform"> 회원가입 하시면 뉴스에 쓴 댓글을 모아서 볼 수 있습니다.</div>';}
?>
					</div>
