		...
		$(document).ready(function () {
			...
			$('#mywrite_enter').click(function(){//제출 클릭시
				if(user_name=="Guest"){
					...
					if(reply==true){
						$("form[name=stranger_call_reply]").submit();
					}
				}
			});
		});
...
<body class="popup_body">
	<h6 class="popup_top"><div class="popup_margin"><img src="../image/list_pineB.png" style="position:relative; top:1px;"/> 댓글 신고하기</div></h6>
	<div id="bodyarea_write">
		<form name="stranger_call_reply" action="stranger_call_reply_submit.php" enctype="multipart/form-data" method="post" accept-charset="UTF-8">
		<div class="popup_content bold">▼ 신고내용을 작성해주세요</div>
		<div id="mywrite_body"><!--내글쓰기-->
			<textarea id="mywrite_content" name="mywrite_content" maxlength="500" class="input_blue"></textarea>
			<div id="mywrite_func">
		...
		<input type="hidden" name="count_upperwrite" value="<?php echo $count_upperwrite;?>"/>
