...
<?php
	$url = "sale_friend.php?";
	$page_name = "sale_friend";
	$table_name = "sale";
	$ad_fixbar_cond = "sale_friend";
	$ad_pop_cond = "sale_friend";
	$ad_side_cond = "sale_friend";
	include 'declare.php';
	...
	<div id="bodyarea">
		<div id="mainbar">
			<div id="mainbody">
				...
				<div class="page_title_expr">※ 친구들이 등록한 물건을 볼 수 있습니다.</div>
...
<?php
	if($user_name != "Guest"){
		include 'sale_friend_recall.php';
	} else if($user_name=="Guest"){
		echo '<div class="guest_inform"> 회원가입 하시면 친구가 올린 중고물품을 볼 수 있습니다.</div>';
	}
?>
				</div>
			</div>
