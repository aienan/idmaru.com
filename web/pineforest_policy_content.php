<?php
	$pineforest_policy_content = '제 1 조 (목적)
이 약관은 파인포레스트(이하 "회사")가 제공하는 이드마루 및 이드마루 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.

제 2 조 (정의)
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 이드마루 및 이드마루 관련 제반 서비스를 의미합니다.
...
a.	1.가입신청자가 이 약관에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 단 "회사"의 회원 재가입 승낙을 얻은 경우에는 예외로 함.
b.	2.실명이 아니거나 타인의 명의를 이용한 경우
c.	3.허위의 정보를 기재하거나, "회사"가 제시하는 내용을 기재하지 않은 경우
d.	4.14세 미만 아동이 법정대리인(부모 등)의 동의를 얻지 아니한 경우
e.	5.이용자의 귀책사유로 인하여 승인이 불가능하거나 기타 규정한 제반 사항을 위반하며 신청하는 경우
...
a.	1.신청 또는 변경 시 허위내용의 등록
b.	2.타인의 정보도용
c.	3."회사"가 게시한 정보의 변경
d.	4."회사"가 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신 또는 게시
e.	5."회사"와 기타 제3자의 저작권 등 지적재산권에 대한 침해
f.	6."회사" 및 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위
g.	7.외설 또는 폭력적인 메시지, 화상, 음성, 기타 공서양속에 반하는 정보를 "서비스"에 공개 또는 게시하는 행위
h.	8.회사의 동의 없이 영리를 목적으로 "서비스"를 사용하는 행위
i.	9.기타 불법적이거나 부당한 행위
...
③"회원"이 계약을 해지하는 경우, "회원"이 작성한 "게시물" 은 삭제되지 않으니 사전에 삭제 후 탈퇴하시기 바랍니다.
