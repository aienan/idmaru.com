	...
	<div id="bodyarea">
		<div id="mainbar">
			<div id="mainbody">
				...
				<div class="page_title_expr">※ 회원님이 등록하신 물건을 볼 수 있습니다.</div>
				...
				<div id="list_search">
					...
					<select id="list_search_category" name="list_search_category">
						<option selected value="all_content">전체</option><option value="title"> 제품명</option><option value="content"> 글내용 </option>
					</select>
...
<?php
	if($user_name != "Guest"){
		include 'sale_recall.php';
	} else if($user_name=="Guest"){
		echo '<div class="guest_inform"> 회원가입 하시면 보유하신 중고물품을 마켓에 등록하실 수 있습니다.</div>';
	}
?>
				</div>
			</div>
