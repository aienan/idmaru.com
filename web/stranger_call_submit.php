<?php
	...
	if($exist==0){//이전의 신고내용이 없을때
		$sql1 = "INSERT INTO stranger_call (caller_num, stranger_num, table_name, count, count_upperwrite, content, writetime) VALUES ($user_num, $stranger_num, '$table_name', $count, 0, '$content', '$writetime')";
