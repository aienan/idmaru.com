...
<?php 
	$url = "club_event_reply.php?";
	$page_name = "club_event_reply";
	$table_name = "club_event";
	$ad_fixbar_cond = "club_event";
	$ad_pop_cond = "club_event";
	$ad_side_cond = "club_event";
	include 'declare.php';
	...
	<div id="bodyarea">
		<div id="mainbar">
			<div id="mainbody">
				...
				<div class="page_title_expr">※ 회원님이 댓글을 쓴 이벤트를 볼 수 있습니다.</div>
				<div id="list_search">
				...
				<div class="content_area">
					<div id="writing_area">
<?php
	if($user_num != 0){include 'club_event_reply_recall.php';}
	else {echo '<div class="guest_inform"> 회원가입 하시면 댓글을 쓴 이벤트를 모아서 볼 수 있습니다.</div>';}
?>
					</div>
