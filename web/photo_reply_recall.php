<?php
	...
	include 'photo_reply_recall_detail.php';
	if($count_link != 0){//세부목록일때
		...
		if($count4 != 0){//결과물이 있을때
			...
			$output .= '<div class="empty_list">댓글을 쓴 사진이 없습니다</div>';
		}
	}
