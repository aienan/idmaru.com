	...
	<div id="bodyarea">
		<div id="mainbar">
			<div id="mainbody">
				...
				<div class="page_title_expr">※ 회원님이 댓글을 쓴 사진을 볼 수 있습니다.</div>
...
<?php
	if($user_num != 0){include 'photo_reply_recall.php';}
	else {echo '<div class="guest_inform"> 회원가입 하시면 댓글을 쓴 사진을 모아서 볼 수 있습니다.</div>';}
?>
