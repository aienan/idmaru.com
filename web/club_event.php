	...
	<div id="bodyarea">
		<div id="mainbar">
			<div id="mainbody">
				...
				<div class="page_title_expr">※ 회원님이 등록하신 이벤트를 볼 수 있습니다.</div>
				<div id="list_search">
				...
				<div class="content_area">
					<div id="writing_area">
<?php
	if($user_num != 0){include 'club_event_recall.php';}
	else {echo '<div class="guest_inform"> 회원가입 하시면 idMaru 이벤트에 올라가는 글을 쓰실 수 있습니다.</div>';}
?>
					</div>
