	...
	<script>
		...
		$(document).ready(function () {
			...
			$('#mywrite_enter').click(function(){
				var reply = confirm("공지 E-Mail을 보내시겠습니까?");
				if(reply==true){}
	...
	<div id="bodyarea">
		<div id="mainbar">
			<div id="mainbody">
				...
				<div class="popup_title bold font12"><img src="../image/list_pine.png" style="position:relative; top:2px;"/> 공지 E-Mail 보내기</div><br/>
				<form action="manager_email_submit.php" enctype="multipart/form-data" method="post" accept-charset="UTF-8">
					...
					<div id="mywrite_body" style="width:725px; padding:0;"><!--내글쓰기-->
						...
						<div id="mywrite_func" style="height:32px;">
							<input id="mywrite_enter" type="image" name="submit" src="../image/button_enter.png" value="전    송"/>
						</div>
					</div>
					</div>
				</form>
