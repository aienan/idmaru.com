	...
	<div id="bodyarea">
		<div id="mainbar">
			<div id="mainbody">
				...
				<form action="manager_email_private_submit.php" enctype="multipart/form-data" method="post" accept-charset="UTF-8">
				<div class="content_area">
					<div style="padding:2px; margin:0 0 5px 0; background-color:#BAD89C; font-size:10pt;">
						<span style="font-weight:bold;">보내는사람 : </span><input type="text" id="mywrite_from" name="mywrite_from" class="" value="" style="padding:2px; width:620px;"/>
					</div>
